...
//
// loggerConfig := stdlib.WithProvider("google.cloud.logging", observer.TypeLogger, NewGoogleStackdriverProvider)
// errorConfig := stdlib.WithProvider("google.cloud.error", observer.TypeErrorReporter, NewGoogleStackdriverProvider)
// metricsConfig := stdlib.WithProvider("google.cloud.metrics", observer.TypeMetrics, NewGoogleStackdriverProvider)
...
var (
	...
	_ stdlib.GenericProvider = (*stackdriverImpl)(nil)
